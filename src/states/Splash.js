...
export default class extends State {
  ...
  preload() {
    this.scale.fullScreenScaleMode = ScaleManager.SHOW_ALL;
    ...
    this.load.image(
      "ristra de ajos_thumb",
      "assets/images/ristra de ajos_thumb.png"
    );
    ...
    this.load.image(
      "trozo de madera_thumb",
      "assets/images/trozo de madera_thumb.png"
    );
