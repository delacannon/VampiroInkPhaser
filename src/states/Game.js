...
export default class extends Phaser.State {
  ...
  createImageBG(image) {
    ...
    if (this.img_bg.key != image) {
      ...
      tp2.to({
        alpha: 1
      }, 600, Phaser.Easing.Circular.Out)
      tp2.start()
    }
  ...
  createParagraphText(text, choices) {
    ...
    choices.forEach(function(choice, i) {
      ...
      tp2.to({
        y: 768 + i * 96,
        alpha: 1
      }, 600, Phaser.Easing.Circular.Out, true, i * 150)
      tp2.start()
      ...
      choiceAlpha.to({
        alpha: 1
      }, 1000, Phaser.Easing.Circular.In)
      choiceAlpha.start()
